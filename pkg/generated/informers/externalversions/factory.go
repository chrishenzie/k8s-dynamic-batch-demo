...
import (
	...
	taskcontroller "github.com/chrishenzie/k8s-dynamic-batch-demo/pkg/generated/informers/externalversions/taskcontroller"
...
func (f *sharedInformerFactory) Taskcontroller() taskcontroller.Interface {
	return taskcontroller.New(f, f.namespace, f.tweakListOptions)
}
