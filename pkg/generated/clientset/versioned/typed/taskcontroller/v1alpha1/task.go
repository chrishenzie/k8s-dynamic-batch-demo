...
type tasks struct {
	*gentype.ClientWithList[*v1alpha1.Task, *v1alpha1.TaskList]
}

// newTasks returns a Tasks
func newTasks(c *TaskcontrollerV1alpha1Client, namespace string) *tasks {
	return &tasks{
		gentype.NewClientWithList[*v1alpha1.Task, *v1alpha1.TaskList](
			"tasks",
			c.RESTClient(),
